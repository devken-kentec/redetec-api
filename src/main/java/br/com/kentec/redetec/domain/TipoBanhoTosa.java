...
@Entity
@Table(name="tipo_banho_tosa")
@SuppressWarnings("serial")
public class TipoBanhoTosa implements Serializable {
	...
	public String toString() {
		return "TipoBanhoTosa [id=" + id + ", descricao=" + descricao + ", valor=" + valor + ", status=" + status + "]";
	}
}
